...
namespace E.ExploreDeezer.UWP.Controls
{
    public sealed partial class AlbumGrid : UserControl
    {
        ...
        public IContentUserControlViewModel<IAlbumViewModel> ViewModel { get; private set; }


        private void OnDataContextChanged(FrameworkElement sender, DataContextChangedEventArgs args)
            => this.ViewModel = args.NewValue as IContentUserControlViewModel<IAlbumViewModel>;
